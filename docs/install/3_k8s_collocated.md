  ...
  template:
    ...
    spec:
      ...
      - args:
        ...
        - name: ENABLE_SCHEMA
          value: "true"
        image: ndd.artifactory-espoo2.int.net.nokia.com/yndd/config-server:v0.0.5
      ...
      - args:
        ...
        command:
        - /app/data-server
        image: ndd.artifactory-espoo2.int.net.nokia.com/yndd/data-server:v0.0.24-cda0cd1
        imagePullPolicy: Always
        name: data-server
        volumeMounts:
        - mountPath: /config
